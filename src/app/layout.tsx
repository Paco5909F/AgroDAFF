...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/images/favicon.ico?v=5" },
      { url: "/images/06-Favicon-16.png?v=5", sizes: "16x16", type: "image/png" },
      { url: "/images/07-Favicon-32.png?v=5", sizes: "32x32", type: "image/png" },
    ],
    apple: [
      { url: "/images/08-Apple-Touch-180.png?v=5", sizes: "180x180", type: "image/png" },
    ],
  }
};
